...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <p class="cara-main mx-auto" style="text-align: center;">Untuk memainkan ini, gunakan tombol W, A, S, D untuk berpindah tempat, game akan berakhir apabila anda berhasil mencapai ke area biru</p>
        </div>
    </div>
